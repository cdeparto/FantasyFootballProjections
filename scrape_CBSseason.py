...
url_qb = 'https://www.fftoday.com/rankings/playerproj.php?Season=2020&PosID=10&LeagueID=26943&order_by=FFPts&sort_order=DESC&cur_page={}'
pages = [0,1]
results = []
for page in pages:
...
result.to_csv('CBSseason.csv',index=False)
